...
<!-- The film. This bare URL is what GitHub turns into a video player, so it must stay
     ...
     docs/media/TAKTO-ONE.mp4 is the durable in-repo copy, currently the v051 master.
...
https://github.com/user-attachments/assets/a3fa5804-f2de-467e-afde-5d7406f9e5a0
...
log — on the same clock as the twelve encoders and three IMUs.
...
and feed the browser twin in real time. Four long-finger assemblies are built and
...
behavior are not characterized by measurements here. Verify the installed IMUs, thumb configuration, actuator
count, limits, and safety behavior on your own hardware before any worn experiment.
